...
import { connectToDatabase , fetchAnalyticsData, fetchLatestUserActions, fetchAnalyticsMotivation, fetchAnalyticsTimeBudget, 
...
const handleDatabaseChange = async (event: React.ChangeEvent<HTMLSelectElement>) => {
  ...
  try {
    ...
    processAndSetData(userActivityData, userRankingData, userInteractionData, userActionsData, motivationData, timeBudgetData);
